(() => {
  ...
  const data = {
    ...
    statistics: Object.freeze({ snapshotDate: "2026-09-07", publicRepositories: projects.length, projectRecords: "15+", githubFollowers: 9, publicGists: 0, featuredVideos: videos.length, courseLessons: 46, courseModules: 21, labLessons: 4, linkedCourseLessons: 4, trainedStudentsClaim: "3,000+", securityToolsAndProjectsClaim: "10+" }),
